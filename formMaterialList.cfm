<cfscript>
	...
	{
		sortURL = SCRIPT_NAME & "?LibID=" & LibID &"&add=" & add & "&";
	}
</cfscript>
					...
					<tr>
						<td>
							...
							<cfelseif isDefined("URL.UserID")>
								<input name="UserID" type="hidden" value="#URL.UserID#">
							</cfif>
							<cfif IsDefined("FORM.MatTypeID")>
								<input name="MatTypeID" type="hidden" value="#FORM.MatTypeID#">
							</cfif>
							<cfif IsDefined("FORM.UnitID")>
								<input name="UnitID" type="hidden" value="#FORM.UnitID#">
							</cfif>
							<cfif IsDefined("FORM.OwnerID")>
								<input name="OwnerID" type="hidden" value="#FORM.OwnerID#">
							</cfif>
							<input type="hidden" name="caller" value="formMaterialList">
							</form>
						</td>
						<td width="12">&nbsp;</td>
						<td>
							<cfif isDefined("FORM.ActID") and FORM.ActID neq "0">
								<form action="session.cfm?ActID=#FORM.ActID#&SessID=#FORM.SessID#" method="post">
							<cfelseif isDefined("URL.ActID") and URL.ActID neq "0">
								<form action="session.cfm?ActID=#URL.ActID#&SessID=#URL.SessID#" method="post">
							<cfelseif isDefined("FORM.UserID") and FORM.UserID neq "0">
								<form action="materials.cfm?LibID=#FORM.UserID#" method="post">
							<cfelseif isDefined("URL.UserID") and URL.UserID neq "0">
								<form action="materials.cfm?LibID=#URL.UserID#" method="post">
