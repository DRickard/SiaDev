...
<cfif FORM.ReportID eq "1">
	<cfinclude template="incTour.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "2">
	<cfinclude template="incLectures.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "3">
	<cfinclude template="incClasses.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "4">
	<cfinclude template="incCredit.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "14">
	<cfinclude template="incScholar.cfm"><!-- updated 20141205 -->
</cfif>
...
<cfif (FORM.ReportID eq "7" and SESSION.UserLevelID neq 3) or FORM.ReportID eq "12">
	<cfinclude template="incGeneral.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "7" and SESSION.UserLevelID eq 3>
	<cfinclude template="incGeneralPlus.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "8">
	<cfinclude template="incMatRpt.cfm"><!-- updated -->
</cfif>
<cfif FORM.ReportID eq "9">
	<cfinclude template="incOutRpt.cfm"><!-- updated 20141205 -->
</cfif>
...
<cfif FORM.ReportID eq "11">
	<cfinclude template="incAllLib.cfm"><!-- updated 20141205 -->
</cfif>
...
<cfif FORM.ReportID eq "17">
	<cfinclude template="incLCS.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "18">
	<cfinclude template="incConsult.cfm"><!-- updated 20141205 -->
</cfif>
<cfif FORM.ReportID eq "19">
	<cfinclude template="incTraining.cfm"><!-- updated 20130619 -->
</cfif>
<cfif FORM.ReportID eq "20">
	<cfinclude template="incOther.cfm"><!-- updated 20130619 -->
</cfif>
<cfinclude template="incRepEnd.cfm">
<!-- deprecated reports -->
<!---cfif FORM.ReportID eq "5">
	<cfinclude template="incConsult.cfm">
</cfif>
<cfif FORM.ReportID eq "13">
	<cfinclude template="incLiaison.cfm">
</cfif--->
