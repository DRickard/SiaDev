...
<cfscript>
	...
	// FileDirectory
	if (isDefined("FILE.serverDirectory"))
	{
		FileDirectory = Replace(FILE.serverDirectory, APPLICATION.FileDirectory, "", "ALL");
	}
	else
	{
		FileDirectory = "";
	...
	// FileName
	if (isDefined("FILE.ClientFile"))
	{
		FileName = FILE.ClientFile;
	}
	else
	{
		FileName = "";
	...
	// FileExtension
	if (isDefined("FILE.ClientFileExt"))
	{
		FileExtension = FILE.ClientFileExt;
	}
	else
	{
		FileExtension = "";
	...
	// FileContentSubtype
	if (isDefined("FILE.ContentSubType"))
	{
		FileContentSubtype = ContentSubType;
	}
	else
	{
		FileContentSubtype = "";
