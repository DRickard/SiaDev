	...
	<div class="data">
		...
		<cfif ( "1,5" contains SESSION.UserLevelID ) and ListContains("materials.cfm", Replace(SCRIPT_NAME, APPLICATION.Path, "", "all"), ",")>
			<form action="addNewMaterial.cfm" method="post">
				<input type="hidden" name="caller" value="incMaterials">
				<cfoutput>
					<input type="hidden" name="matCount" value="#Material.RecordCount#">
				</cfoutput>
				<input type="submit" class="mainControl" value="Add Material">
			</form>
		</cfif>
	</div>
<cfelse>
	...
	<div class="data">
		...
		<cfif ( "1,5" contains SESSION.UserLevelID ) and ListContains("materials.cfm", Replace(SCRIPT_NAME, APPLICATION.Path, "", "all"), ",")>
			<form action="addRemoveMaterial.cfm" method="post">
				...
				<input type="submit" class="mainControl" value="Add/Remove Material">
			</form>
		</cfif>
	</div>
</cfif>
